...
export default function MentionsLegales() {
  ...
  const sections = isFr ? [
    { title: 'Éditeur du site', content: `Le site Sidereal est édité par Sidereal SAS, société par actions simplifiée au capital de 10 000 €.\n\nSiège social : Paris, France\nEmail : contact@sidereal.com\nDirecteur de la publication : Quentin Leroux` },
    { title: 'Hébergement', content: `Le site est hébergé par Vercel Inc.\n101 2nd St Ste 700, San Francisco, CA 94105, États-Unis\nSite : https://vercel.com` },
    { title: 'Propriété intellectuelle', content: `L'ensemble des contenus présents sur ce site (textes, images, graphiques, logos, icônes, sons, logiciels) est la propriété exclusive de Sidereal ou de ses partenaires. Toute reproduction, distribution, modification ou utilisation de ces contenus, sans autorisation écrite préalable, est strictement interdite.` },
    { title: 'Responsabilité', content: `Sidereal s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur ce site. Toutefois, Sidereal ne peut garantir l'exactitude, la précision ou l'exhaustivité des informations mises à disposition. En conséquence, Sidereal décline toute responsabilité pour toute imprécision, inexactitude ou omission portant sur des informations disponibles sur ce site.` },
    { title: 'Liens hypertextes', content: `Ce site peut contenir des liens vers d'autres sites internet. Sidereal n'exerce aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu.` },
    ...
    { title: 'Site Publisher', content: `The Sidereal website is published by Sidereal SAS, a simplified joint-stock company with share capital of €10,000.\n\nHeadquarters: Paris, France\nEmail: contact@sidereal.com\nPublication Director: Quentin Leroux` },
    { title: 'Hosting', content: `The site is hosted by Vercel Inc.\n101 2nd St Ste 700, San Francisco, CA 94105, United States\nWebsite: https://vercel.com` },
    { title: 'Intellectual Property', content: `All content on this site (texts, images, graphics, logos, icons, sounds, software) is the exclusive property of Sidereal or its partners. Any reproduction, distribution, modification or use of this content, without prior written authorization, is strictly prohibited.` },
    { title: 'Liability', content: `Sidereal strives to ensure the accuracy and currency of information published on this site. However, Sidereal cannot guarantee the accuracy, precision or completeness of the information provided. Consequently, Sidereal disclaims all liability for any inaccuracy, imprecision or omission relating to information available on this site.` },
    { title: 'Hyperlinks', content: `This site may contain links to other websites. Sidereal has no control over these sites and disclaims all responsibility for their content.` },
