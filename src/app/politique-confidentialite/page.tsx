...
export default function PolitiqueConfidentialite() {
  ...
  const sections = isFr ? [
    { title: '1. Responsable du traitement', content: `Sidereal SAS, dont le siège social est situé à Paris, France, est responsable du traitement de vos données personnelles.\nContact DPO : contact@sidereal.com` },
    ...
    { title: '9. Contact & Réclamations', content: `Pour toute question relative à cette politique ou pour exercer vos droits, contactez-nous à : contact@sidereal.com\n\nVous disposez également du droit d'introduire une réclamation auprès de la CNIL (www.cnil.fr).` },
  ] : [
    { title: '1. Data Controller', content: `Sidereal SAS, headquartered in Paris, France, is the controller of your personal data.\nDPO contact: contact@sidereal.com` },
    ...
    { title: '9. Contact & Complaints', content: `For any questions regarding this policy or to exercise your rights, contact us at: contact@sidereal.com\n\nYou also have the right to lodge a complaint with the CNIL (www.cnil.fr).` },
  ];
